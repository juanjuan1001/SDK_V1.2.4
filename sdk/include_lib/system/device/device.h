...
#define __SFC_NAME          "sfc"
#define __MSFC_NAME         "msfc"
#define __EXT_FLASH_BULK    "ext_flsh_bulk"
#define __EXT_FLASH_BYTE    "ext_flsh_byte"
#define __OTG               "otg"
...
extern const struct device_operations norflash_dev_ops;//支持512byte为单位读写
extern const struct device_operations norfs_dev_ops;//支持1byte为单位读写
extern const struct device_operations msfc_dev_ops;//支持512byte为单位读写
