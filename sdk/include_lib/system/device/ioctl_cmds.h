...
#define IOCTL_GET_ID 					100 //不可改动
#define IOCTL_GET_SECTOR_SIZE			101 //不可改动
#define IOCTL_GET_BLOCK_SIZE			102 //不可改动
#define IOCTL_GET_CAPACITY 				103 //不可改动
...
#define IOCTL_ERASE_SECTOR 				200 //不可改动
#define IOCTL_ERASE_BLOCK 				201 //不可改动
#define IOCTL_ERASE_CHIP 				202
#define IOCTL_SET_ENC_END               203
#define IOCTL_ERASE_PAGE                204 //不可改动
