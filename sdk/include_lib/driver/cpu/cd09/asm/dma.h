...
#define DMA_GEN_BIT_TMR0_PRD_MATCH      0
#define DMA_GEN_BIT_TMR1_PRD_MATCH      1
#define DMA_GEN_BIT_TMR2_PRD_MATCH      2
#define DMA_GEN_BIT_TMR3_PRD_MATCH      3
#define DMA_GEN_BIT_TMR0_CPT            4
#define DMA_GEN_BIT_TMR1_CPT            5
#define DMA_GEN_BIT_TMR2_CPT            6
#define DMA_GEN_BIT_TMR3_CPT            7
#define DMA_GEN_BIT_TMR0_PWM            8
#define DMA_GEN_BIT_TMR1_PWM            9
#define DMA_GEN_BIT_TMR2_PWM            10
#define DMA_GEN_BIT_TMR3_PWM            11
#define DMA_GEN_BIT_MCPWM0_PWM_H        12
#define DMA_GEN_BIT_MCPWM1_PWM_H        13
#define DMA_GEN_BIT_MCPWM2_PWM_H        14
#define DMA_GEN_BIT_MCPWM3_PWM_H        15
#define DMA_GEN_BIT_MCPWM4_PWM_H        16
#define DMA_GEN_BIT_MCPWM5_PWM_H        17
#define DMA_GEN_BIT_MCPWM0_PWM_L        18
#define DMA_GEN_BIT_MCPWM1_PWM_L        19
#define DMA_GEN_BIT_MCPWM2_PWM_L        20
#define DMA_GEN_BIT_MCPWM3_PWM_L        21
#define DMA_GEN_BIT_MCPWM4_PWM_L        22
#define DMA_GEN_BIT_MCPWM5_PWM_L        23
#define DMA_GEN_BIT_MCPWM0_TMR_OVF      24
#define DMA_GEN_BIT_MCPWM1_TMR_OVF      25
#define DMA_GEN_BIT_MCPWM2_TMR_OVF      26
#define DMA_GEN_BIT_MCPWM3_TMR_OVF      27
#define DMA_GEN_BIT_MCPWM4_TMR_OVF      28
#define DMA_GEN_BIT_MCPWM5_TMR_OVF      29
#define DMA_GEN_BIT_MCPWM0_TMR_ZERO     30
#define DMA_GEN_BIT_MCPWM1_TMR_ZERO     31
#define DMA_GEN_BIT_MCPWM2_TMR_ZERO     32
#define DMA_GEN_BIT_MCPWM3_TMR_ZERO     33
#define DMA_GEN_BIT_MCPWM4_TMR_ZERO     34
#define DMA_GEN_BIT_MCPWM5_TMR_ZERO     35
#define DMA_GEN_BIT_MCPWM0_FPIN_EDGE    36
#define DMA_GEN_BIT_MCPWM1_FPIN_EDGE    37
#define DMA_GEN_BIT_MCPWM2_FPIN_EDGE    38
#define DMA_GEN_BIT_MCPWM3_FPIN_EDGE    39
#define DMA_GEN_BIT_MCPWM4_FPIN_EDGE    40
#define DMA_GEN_BIT_MCPWM5_FPIN_EDGE    41
#define DMA_GEN_BIT_SARADC_TRI          42
#define DMA_GEN_BIT_HADC_OPA_CMP        43
#define DMA_GEN_BIT_DAC_PA_CMP          44
...
typedef struct {
    ...
    void (*isr_cb)(enum dma_int_type int_type);//中断回调函数,参数为中断类型,传输一半或者传输完成或者循环完成
    //dma generator cfg
    enum dma_gen_pol gen_pol;           //触发极性选择(传输模式不是M2M时有效)
    u8 gen_req_num;                     //一次触发产生的DMA请求数目,实际上产生的DMA请求数目为req_num+1(传输模式不是M2M时有效)
    u8 gen_sel;                         //DMA触发器外设源选择(传输模式不是M2M时有效)
} dma_cfg;
...
//@return: NULL
//=================================================================================//
void dma_init(enum dma_index dma, dma_cfg *cfg);
...
//=================================================================================//
void dma_cmd(enum dma_index dma, enum dma_cmd cmd);
...
//=================================================================================//
void dma_int_config(enum dma_index dma, enum dma_int_type dma_int, u8 en);
...
//=================================================================================//
u8 dma_get_pend(enum dma_index dma, enum dma_int_type dma_int);
...
//=================================================================================//
void dma_wait_pend(enum dma_index dma, enum dma_int_type dma_int);
...
//=================================================================================//
u16 dma_get_complete_len(enum dma_index dma);
