...
#define MCPWM_FPIN_FLT_PR  0 //5bit
...
/* 故障检测端口 */
typedef enum {
    MCPWM_FPIN_IO_PORTC_11 = 0,
    MCPWM_FPIN_HADC_OPA_CMP,//使用前需要提前把OPA初始化成比较器模式
    MCPWM_FPIN_DAC_PA_CMP,//使用前需要提前把PA初始化成比较器模式
    MCPWM_FPIN_NONE,
} mcpwm_fpin;
