...
#define     JL_TEST_CLASS       0x00000080
...
#define MOUNT_RESET                         30
#define MOUNT_TIMEOUT                       300
...
#if (USB_DEVICE_CLASS_CONFIG & JL_TEST_CLASS)
#define TCFG_USB_SLAVE_JL_TEST_ENABLE           1
#else
#define TCFG_USB_SLAVE_JL_TEST_ENABLE           0
#endif
