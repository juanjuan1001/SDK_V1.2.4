...
void spi_slave_test1(hw_spi_dev spi)
{
    struct spi_platform_data spix_p_data_test = {
        .port = {
            IO_PORTC_05, //clk any io
            IO_PORTC_06, //do any io
            IO_PORTC_07, //di any io
            IO_PORTC_08, //d2 any io
            IO_PORTC_09, //d3 any io
            IO_PORTC_10, //cs any io
        },
        .role = SPI_ROLE_SLAVE,
...
//init cs(cs 中断)
    ...
    gpio_irq_config(PORTC, &gpio_irq_config_test);//通信结束
